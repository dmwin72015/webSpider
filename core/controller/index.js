...
module.exports = {
    ...
    'article/:artid': function(req, res, next) {
        ...
        var sql = '(SELECT ID, arti_name, arti_author_name, arti_textcontent, arti_htmlcontent, arti_sorce, arti_label, arti_cate_name, pub_time, read_num FROM blog_article WHERE id<? ORDER BY id desc limit 1) UNION ALL (SELECT ID, arti_name, arti_author_name, arti_textcontent, arti_htmlcontent, arti_sorce, arti_label, arti_cate_name, pub_time, read_num FROM blog_article WHERE id >=? ORDER BY id ASC LIMIT 2);'
                ...
                if (result.length == 3) {
                    ...
                    if (tempIndex == -1) {
                        ...
                        res.render('blog/article', {
                            ...
                            source: result[tempIndex].arti_sorce,
                            html: sHtml,
